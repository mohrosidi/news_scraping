...
# link dari daftar berita tersebut, kita memerlukan web scraper 
# yang dapat menangani javascript pada website tersebut. Daftar 
# tautan berita yang telah diambil dengan bantuan web scraper
# selanjutnya akan dilakukan scraping menggunakan bantuan rvest.
#
# Web scraper merupakan ekstensi google chrome yang dapat digunakan
# untuk melakukan web scraping. Ekstensi ini bersifat gratis dan
# mudah digunakan.
# 
...
# Membaca Tautan Hasil Scraping Web Scraper -----

tautan <- read_csv('data/kumparan_haji2020.csv') %>%
  select(`berita-href`) %>%
  pull()
